    ...
    public void perform(Player player, String[] args) {
        ...
        if (armorStandList.isEmpty()) {
            ...
            for (String name : armorStandList) {
                ...
                TextComponent nameComponent = new TextComponent((ArmorStandUtils.isLoaded(ArmorStandUtils.getArmorStandByName(name)) ? ChatColor.GREEN : (ArmorStandsConfig.get().getBoolean("armorstands." + name + ".deleted")) ?  ChatColor.GRAY :  ChatColor.RED) + "" + ChatColor.BOLD + name);
