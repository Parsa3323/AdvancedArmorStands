...
public class Portuguese extends Language {
    ...
    */
    public Portuguese() {
        ...
        yml.addDefault(Messages.TELEPORTED_TO_ARMORSTAND, "&aTeleportado para %name%");
        yml.addDefault(Messages.ARMORSTAND_UPDATED_SUCCESS, "&aArmorStand atualizado com sucesso!");
        yml.addDefault(Messages.ARMORSTAND_UPDATED_FAILED, "&cFalha ao atualizar o ArmorStand!");
        ...
        yml.addDefault(Messages.ARMORSTAND_DELETE_CONFIRM, "&cFaça isso mais %amount% vez%plural% para excluir este ArmorStand.");
        yml.addDefault(Messages.ARMORSTAND_DELETED_SUCCESS, "&aO ArmorStand foi excluído, mas pode ser restaurado usando o comando restore. Ele será excluído completamente quando o servidor reiniciar");
