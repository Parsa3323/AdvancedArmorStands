...
public class Russian extends Language {
    ...
    */
    public Russian() {
        ...
        yml.addDefault(Messages.ARMOR_STAND_NOT_FOUND, "&cArmorStand не найден!");
        yml.addDefault(Messages.WORLD_NOT_FOUND, "&cМир не найден!");
        yml.addDefault(Messages.TELEPORTED_TO_ARMOR_STAND, "&aТы телепортирован к %name%");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_SUCCESS, "&aArmorStand успешно обновлён!");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_FAILED, "&cНе удалось обновить ArmorStand!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE, "&cArmorStand больше недоступен!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE_TITLE, "&cArmorStand недоступен");
        yml.addDefault(Messages.ARMOR_STAND_MOVE_SUCCESS, "&aArmorStand успешно перемещён.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_SAVE_CONFIRM, "&aСделай это ещё %amount% раз%plural%, чтобы сохранить этот ArmorStand.");
        yml.addDefault(Messages.ARMOR_STAND_SAVED_SUCCESS, "&eArmorStand сохранён как %name%!");
        yml.addDefault(Messages.ARMOR_STAND_DELETE_CONFIRM, "&cСделай это ещё %amount% раз%plural%, чтобы удалить этот ArmorStand.");
        yml.addDefault(Messages.ARMOR_STAND_DELETED_SUCCESS, "&aArmorStand удалён, но его можно восстановить командой restore. Полностью он удалится после перезапуска сервера");
