...
public class Romanian extends Language {
    ...
    */
    public Romanian() {
        ...
        yml.addDefault(Messages.ARMOR_STAND_NOT_FOUND, "&cArmorStand negăsit!");
        yml.addDefault(Messages.WORLD_NOT_FOUND, "&cLume negăsită!");
        yml.addDefault(Messages.TELEPORTED_TO_ARMOR_STAND, "&aTeleportat la %name%");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_SUCCESS, "&aArmorStand actualizat cu succes!");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_FAILED, "&cActualizarea ArmorStand-ului a eșuat!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE, "&cArmorStand-ul nu mai este disponibil!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE_TITLE, "&cArmorStand-ul nu este disponibil");
        yml.addDefault(Messages.ARMOR_STAND_MOVE_SUCCESS, "&aArmorStand mutat cu succes.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_SAVE_CONFIRM, "&aFă asta încă %amount% dată%plural% ca să salvezi acest ArmorStand.");
        yml.addDefault(Messages.ARMOR_STAND_SAVED_SUCCESS, "&eArmorStand salvat ca %name%!");
        yml.addDefault(Messages.ARMOR_STAND_DELETE_CONFIRM, "&cFă asta încă %amount% dată%plural% ca să ștergi acest ArmorStand.");
        yml.addDefault(Messages.ARMOR_STAND_DELETED_SUCCESS, "&aArmorStand-ul a fost șters, dar poate fi restaurat cu comanda restore și va fi șters complet la repornirea serverului");
