...
public class Turkish extends Language {
    ...
    */
    public Turkish() {
        ...
        yml.addDefault(Messages.ARMOR_STAND_NOT_FOUND, "&cArmorStand bulunamadı!");
        yml.addDefault(Messages.WORLD_NOT_FOUND, "&cDünya bulunamadı!");
        yml.addDefault(Messages.TELEPORTED_TO_ARMOR_STAND, "&a%name%'e ışınlandın");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_SUCCESS, "&aArmorStand başarıyla güncellendi!");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_FAILED, "&cArmorStand güncellenemedi!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE, "&cArmorStand artık mevcut değil!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE_TITLE, "&cArmorStand mevcut değil");
        yml.addDefault(Messages.ARMOR_STAND_MOVE_SUCCESS, "&aArmorStand başarıyla taşındı.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_SAVE_CONFIRM, "&aBu ArmorStand'ı kaydetmek için bunu %amount% kez daha yap.");
        yml.addDefault(Messages.ARMOR_STAND_SAVED_SUCCESS, "&eArmorStand %name% olarak kaydedildi!");
        yml.addDefault(Messages.ARMOR_STAND_DELETE_CONFIRM, "&cBu ArmorStand'ı silmek için bunu %amount% kez daha yap.");
        yml.addDefault(Messages.ARMOR_STAND_DELETED_SUCCESS, "&aArmorStand silindi, ancak restore komutuyla geri getirebilirsin ve sunucu yeniden başladığında tamamen silinecek");
