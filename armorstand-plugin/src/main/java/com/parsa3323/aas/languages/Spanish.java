...
public class Spanish extends Language {
    ...
    */
    public Spanish() {
        ...
        yml.addDefault(Messages.KEYFRAME_REALISTIC_NAME_LORE, "&7Las animaciones realistas interpolan suavemente\n&7entre los pasos de la animación en lugar de\n&7saltar instantáneamente de una pose a otra.\n\n&7Advertencia: podría causar lag\n\n&eHaz clic para cambiar");
        yml.addDefault(Messages.KEYFRAME_REALISTIC_FRAMES_DISPLAY, "&eFrames realistas: %value%");
        yml.addDefault(Messages.KEYFRAME_REALISTIC_FRAMES_LORE, "&7La cantidad de frames generados\n&7durante la animación realista\n\n&6»&e Clic izquierdo para aumentar\n&6»&e Clic derecho para disminuir.\n&6»&e Mantén Shift para cambiar\n&6»&e en incrementos de 10.\n\n&eHaz clic para cambiar");
        ...
        yml.addDefault(Messages.ARMOR_STAND_LOAD_SUCCESS, "&aEl soporte para armadura '%name%' se ha cargado correctamente");
        yml.addDefault(Messages.ARMOR_STAND_LOAD_FAILED, "&cNo se pudo cargar el soporte para armadura. ¡Revisa la consola para obtener más detalles!");
        yml.addDefault(Messages.ARMOR_STAND_LOAD_LOADED, "&cEste soporte para armadura ya está cargado");
        yml.addDefault(Messages.ARMOR_STANDS_LOAD_SUCCESS, "&aSe cargaron correctamente %loaded% soportes para armadura.");
        yml.addDefault(Messages.ARMOR_STANDS_LOAD_FAILED, "&cNo se pudieron cargar %failed% soportes para armadura.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_NOT_FOUND, "&c¡ArmorStand no encontrado!");
        yml.addDefault(Messages.WORLD_NOT_FOUND, "&c¡Mundo no encontrado!");
        yml.addDefault(Messages.TELEPORTED_TO_ARMOR_STAND, "&aTeletransportado a %name%");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_SUCCESS, "&a¡ArmorStand actualizado correctamente!");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_FAILED, "&c¡No se pudo actualizar el ArmorStand!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE, "&c¡El ArmorStand ya no está disponible!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE_TITLE, "&cEl ArmorStand no está disponible");
        yml.addDefault(Messages.ARMOR_STAND_MOVE_SUCCESS, "&aArmorStand movido correctamente.");
        yml.addDefault(Messages.MESSAGES_NOT_LOADED, "&cParece que %amount% ArmorStands no han sido cargados por el generador del mundo. Para solucionarlo, activa 'auto-load-armor-stands' en la configuración para cargarlos todos automáticamente.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_SAVE_CONFIRM, "&aHaz esto %amount% vez%plural% más para guardar este ArmorStand.");
        yml.addDefault(Messages.ARMOR_STAND_SAVED_SUCCESS, "&e¡ArmorStand guardado como %name%!");
        yml.addDefault(Messages.ARMOR_STAND_DELETE_CONFIRM, "&cHaz esto %amount% vez%plural% más para eliminar este ArmorStand.");
        yml.addDefault(Messages.ARMOR_STAND_DELETED_SUCCESS, "&aEl ArmorStand ha sido eliminado, pero puedes restaurarlo con el comando restore. Se eliminará por completo al reiniciar el servidor");
        ...
        yml.addDefault(Messages.UNLINK_SUCCESS, "&aEl soporte para armadura se ha desvinculado correctamente de AdvancedArmorStands");
        yml.addDefault(Messages.UNLINK_ALL_SUCCESS, "&aTodos los soportes para armadura se han desvinculado correctamente de AdvancedArmorStands");
