...
public class Persian extends Language {
    ...
    */
    public Persian() {
        ...
        yml.addDefault(Messages.ARMOR_STAND_NOT_FOUND, "&cArmorStand peida nashod!");
        yml.addDefault(Messages.WORLD_NOT_FOUND, "&cWorld peida nashod!");
        yml.addDefault(Messages.TELEPORTED_TO_ARMOR_STAND, "&aBe %name% teleport shodi");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_SUCCESS, "&aArmorStand ba movafaghiat update shod!");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_FAILED, "&cUpdate ArmorStand shekast khord!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE, "&cIn ArmorStand digge mojud nist!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE_TITLE, "&cArmorStand mojud nist");
        yml.addDefault(Messages.ARMOR_STAND_MOVE_SUCCESS, "&aArmorStand ba movafaghiat jabeja shod.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_SAVE_CONFIRM, "&aIn karo %amount% bar%plural% dige anjam bede ta in ArmorStand save beshe.");
        yml.addDefault(Messages.ARMOR_STAND_SAVED_SUCCESS, "&eArmorStand ba esme %name% save shod!");
        yml.addDefault(Messages.ARMOR_STAND_DELETE_CONFIRM, "&cIn karo %amount% bar%plural% dige anjam bede ta in ArmorStand hazf beshe.");
        yml.addDefault(Messages.ARMOR_STAND_DELETED_SUCCESS, "&aArmorStand hazf shod, vali mitoni ba command restore bargardunish, va ba restart shodane server kamelan pak mishe");
