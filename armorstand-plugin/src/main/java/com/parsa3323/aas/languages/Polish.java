...
public class Polish extends Language {
    ...
    */
    public Polish() {
        ...
        yml.addDefault(Messages.ARMOR_STAND_LOAD_SUCCESS, "&aStojak na zbroję '%name%' został pomyślnie załadowany");
        yml.addDefault(Messages.ARMOR_STAND_LOAD_FAILED, "&cNie udało się załadować stojaka na zbroję. Sprawdź konsolę, aby uzyskać więcej informacji!");
        yml.addDefault(Messages.ARMOR_STAND_LOAD_LOADED, "&cTen stojak na zbroję jest już załadowany");
        yml.addDefault(Messages.ARMOR_STANDS_LOAD_SUCCESS, "&aPomyślnie załadowano %loaded% stojaków na zbroję.");
        yml.addDefault(Messages.ARMOR_STANDS_LOAD_FAILED, "&cNie udało się załadować %failed% stojaków na zbroję.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_NOT_FOUND, "&cNie znaleziono ArmorStanda!");
        yml.addDefault(Messages.WORLD_NOT_FOUND, "&cNie znaleziono świata!");
        yml.addDefault(Messages.TELEPORTED_TO_ARMOR_STAND, "&aTeleportowano do %name%");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_SUCCESS, "&aArmorStand zaktualizowany pomyślnie!");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_FAILED, "&cNie udało się zaktualizować ArmorStanda!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE, "&cArmorStand nie jest już dostępny!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE_TITLE, "&cArmorStand jest niedostępny");
        yml.addDefault(Messages.ARMOR_STAND_MOVE_SUCCESS, "&aArmorStand przeniesiono pomyślnie.");
        yml.addDefault(Messages.MESSAGES_NOT_LOADED, "&cWygląda na to, że %amount% ArmorStandów nie zostało załadowanych przez generator świata. Aby to naprawić, włącz 'auto-load-armor-stands' w konfiguracji, żeby wszystkie ładowały się automatycznie.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_SAVE_CONFIRM, "&aZrób to jeszcze %amount% raz%plural%, aby zapisać tego ArmorStanda.");
        yml.addDefault(Messages.ARMOR_STAND_SAVED_SUCCESS, "&eArmorStand zapisano jako %name%!");
        yml.addDefault(Messages.ARMOR_STAND_DELETE_CONFIRM, "&cZrób to jeszcze %amount% raz%plural%, aby usunąć tego ArmorStanda.");
        yml.addDefault(Messages.ARMOR_STAND_DELETED_SUCCESS, "&aArmorStand został usunięty, ale można go przywrócić komendą restore. Zostanie usunięty całkowicie po restarcie serwera");
