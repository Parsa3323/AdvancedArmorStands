...
public class Indonesian extends Language {
    ...
    */
    public Indonesian() {
        ...
        yml.addDefault(Messages.ARMOR_STAND_NOT_FOUND, "&cArmorStand tidak ditemukan!");
        yml.addDefault(Messages.WORLD_NOT_FOUND, "&cWorld tidak ditemukan!");
        yml.addDefault(Messages.TELEPORTED_TO_ARMOR_STAND, "&aBerhasil teleport ke %name%");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_SUCCESS, "&aArmorStand berhasil diperbarui!");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_FAILED, "&cGagal memperbarui ArmorStand!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE, "&cArmorStand ini sudah tidak ada!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE_TITLE, "&cArmorStand tidak tersedia");
        yml.addDefault(Messages.ARMOR_STAND_MOVE_SUCCESS, "&aArmorStand berhasil dipindahkan.");
        ...
        yml.addDefault(Messages.ARMOR_STAND_SAVE_CONFIRM, "&aLakukan ini %amount% kali lagi untuk menyimpan ArmorStand ini.");
        yml.addDefault(Messages.ARMOR_STAND_SAVED_SUCCESS, "&eArmorStand disimpan sebagai %name%!");
        yml.addDefault(Messages.ARMOR_STAND_DELETE_CONFIRM, "&cLakukan ini %amount% kali lagi untuk menghapus ArmorStand ini.");
        yml.addDefault(Messages.ARMOR_STAND_DELETED_SUCCESS, "&aArmorStand telah dihapus, tapi bisa dipulihkan dengan perintah restore, dan akan terhapus permanen saat server restart");
