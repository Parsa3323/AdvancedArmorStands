...
public class Bangla extends Language {
    ...
    */
    public Bangla() {
        ...
        yml.addDefault(Messages.ARMOR_STAND_NOT_FOUND, "&cআর্মারস্ট্যান্ড খুঁজে পাওয়া যায়নি!");
        yml.addDefault(Messages.WORLD_NOT_FOUND, "&cওয়ার্ল্ড খুঁজে পাওয়া যায়নি!");
        yml.addDefault(Messages.TELEPORTED_TO_ARMOR_STAND, "&a%name%-এর কাছে টেলিপোর্ট হয়েছে");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_SUCCESS, "&aআর্মারস্ট্যান্ড সফলভাবে আপডেট হয়েছে!");
        yml.addDefault(Messages.ARMOR_STAND_UPDATED_FAILED, "&cআর্মারস্ট্যান্ড আপডেট করা যায়নি!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE, "&cআর্মারস্ট্যান্ডটা আর নেই!");
        yml.addDefault(Messages.ARMOR_STAND_UNAVAILABLE_TITLE, "&cআর্মারস্ট্যান্ডটা পাওয়া যাচ্ছে না");
        yml.addDefault(Messages.ARMOR_STAND_MOVE_SUCCESS, "&aআর্মারস্ট্যান্ড সফলভাবে সরানো হয়েছে।");
        ...
        yml.addDefault(Messages.ARMOR_STAND_SAVE_CONFIRM, "&aএই আর্মারস্ট্যান্ডটা সেভ করতে এটা আরও %amount% বার করো।");
        yml.addDefault(Messages.ARMOR_STAND_SAVED_SUCCESS, "&eআর্মারস্ট্যান্ড %name% নামে সেভ হয়েছে!");
        yml.addDefault(Messages.ARMOR_STAND_DELETE_CONFIRM, "&cএই আর্মারস্ট্যান্ডটা মুছতে এটা আরও %amount% বার করো।");
        yml.addDefault(Messages.ARMOR_STAND_DELETED_SUCCESS, "&aআর্মারস্ট্যান্ডটা মোছা হয়েছে, তবে restore কমান্ড দিয়ে এটা ফিরিয়ে আনা যাবে, সার্ভার রিস্টার্ট হলে এটা পুরোপুরি মুছে যাবে");
